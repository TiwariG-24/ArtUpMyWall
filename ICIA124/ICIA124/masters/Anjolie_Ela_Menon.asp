				...
				$('#images').exposure({controlsTarget : '#controls',
					...
					onImage : function(image, imageData, thumb) {
						...
						var hideImageData = function() {
							...
							imageData.stop().show().animate({bottom:imageDataBottom+'px'},{queue:true,duration:160});
						}
	  ...
	  <div class="acci-section">
			<div class="acci-content">
				...
				<ul class="acci" id="nestedi">
                  ...
                  <li> <div id="artistmenubtn"><a href="../masters/Anjolie_Ela_Menon.asp" style="text-decoration:none; color:#A10F0F;">Anjolie Ela Menon</a></div>                  
...
<table width="785" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="733" height="100" valign="top" bgcolor="#FFFFFF"><div id="galeryhedder">
      <div class="bredcum">GALLERY ><a href="#" class="bredcumlink"> ANJOLIE ELA MENON</a></div>
  </div>
 
     <div id="galleryboxdiv">
     <div class="panel">
				<ul id="images">
					<li><a href="../images/artist/Anjolie_Ela_Menon/larges/t_01.jpg"><img src="../images/artist/Anjolie_Ela_Menon/thumb/t_01.jpg" title="<b>Title : </b>Beach Party<br><b>Medium : </b> Acrylic on Canvas<br><b>Size : </b>36 x 24 in<br><b>Year : </b> 2011<br>" /></a></li>
					<li><a href="../images/artist/Anjolie_Ela_Menon/larges/t_02.jpg"><img src="../images/artist/Anjolie_Ela_Menon/thumb/t_02.jpg" title="<b>Title : </b>Untitled<br><b>Medium : </b> Oil on Masamite Board<br><b>Size  : </b>24 x 17 in.<br><b>Year : </b> 2012" /></a></li>
			...
			<div id="exposure"></div>	
            	<div>
					<form action="../mpauth.asp" method="post">
					<input type="submit" class="button" name="BuyButt" value="Buy Now"></form></div>	

                  ...
                  <li> <div id="artistmenubtn"><a href="../masters/Anjolie_Ela_Menon.asp" style="text-decoration:none; color:#999999;">Anjolie Ela Menon</a></div>                   
                      <div id="artistmenubtn"><a href="../masters/FN_Souza.asp" style="text-decoration:none; color:#999999;">FN Souza</a></div>
                       ...
                       <div id="artistmenubtn"><a href="../masters/SH_Raza.asp" style="text-decoration:none; color:#999999;">SH Raza</a></div>
                        <div id="artistmenubtn"><a href="../masters/Tyeb_Mehta.asp" style="text-decoration:none; color:#A10F0F;">Tyeb Mehta</a></div>
...
<table width="785" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="733" height="100" valign="top" bgcolor="#FFFFFF"><div id="galeryhedder">
      <div class="bredcum">GALLERY  > <a href="#" class="bredcumlink">TYEB MEHTA</a></div>
  </div>
 
     <div id="galleryboxdiv">
     <div class="panel">
				<ul id="images">
					<li><a href="../images/artist/Tyeb_Mehta/larges/t_01.jpg"><img src="../images/artist/Tyeb_Mehta/thumb/t_01.jpg" border="none" title="<b>Title : </b>Bird<br><b>Medium : </b> Crayon on Paper<br><b>Size : </b>24 x 20<br><b>Year : </b>2002 <br>" /></a></li>
					<li><a href="../images/artist/Tyeb_Mehta/larges/4.jpg"><img src="../images/artist/Tyeb_Mehta/thumb/t_02.jpg" border="none" title="<b>Title : </b><br><b>Rs. 30,613,000</b> <br><b>US$. 600,255</b>" /></a></li>
				</ul>
				
				<div class="clear"></div>
			</div>
			<div id="exposure"></div>	
            	<div><form action="../authT.asp" method="post">
					<input type="submit" class="button" name="BuyT" value="Buy Now"></form></a></div>	

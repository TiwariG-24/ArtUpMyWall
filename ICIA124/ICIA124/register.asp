...
<div id="bttn2"><a href="#" style="color:#a10f0f; text-decoration:none;">REGISTER</a></div>
...
<table width="785" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="733" height="100" valign="top" bgcolor="#FFFFFF"><div id="galeryhedder"><div class="bredcum">REGISTER</div></div><!--<div>
      <img src="images/home-page_new3.jpg" width="733" height="394"></div>--><div class="contactus"><font style="font-size:16px; color:#a10f0f;"><br>
        <form name="RegForm" action="pass.asp" method="post">
			
			First name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" tabindex="1" name="Fname" required><br><br>
			Last name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" tabindex="2" name="Lname" required><br><br>
			Email &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="email"  tabindex="3" name="Email" required><br><br>
      Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" tabindex="4" name="Number" required><br><br>
			Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  tabindex="5" name="Address" required><br><br>
			Username&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  tabindex="6" name="Username" required><br><br>
			Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password"  tabindex="7" name="password" required><br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="Submit" class="button" value="Register"  tabindex="8">
			<%Response.Write(Session("rd"))%>
			</form>
      </div></td>
